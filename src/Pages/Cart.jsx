...
const Cart = () => {
  ...
  return (
    <div className="mb-10">
      {cart.length > 0 ? (
        <div className="flex flex-row justify-between max-[1300px] mx-auto gap-x-5 " >
          {/* Cart Item  */}
          ...
          {/* Summary */}
          <div className="w-[40%] mt-5 flex flex-col max-h-[25rem]">
            ...
            <div className="flex flex-col">
              ...
              <button onClick={checkout} className="bg-green-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl mr-10">
                CheckOut Now
              </button>
            </div>
          </div>
